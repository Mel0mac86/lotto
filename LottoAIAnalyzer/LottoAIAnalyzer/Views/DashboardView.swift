...
struct DashboardView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: Theme.stackSpacing) {
                ...
                // I riquadri sono divisi in gruppi perché un ViewBuilder accetta
                // al massimo dieci figli diretti.
    ...
    @ViewBuilder
    private var analysisTiles: some View {
    ...
    @ViewBuilder
    private var combinationTiles: some View {
    ...
    @ViewBuilder
    private var labTiles: some View {
